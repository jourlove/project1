<?php /* Smarty version Smarty-3.1.7, created on 2018-05-15 21:15:21
         compiled from "D:/Develop/xampp/htdocs/vr720/template\default\member\project.lbi" */ ?>
<?php /*%%SmartyHeaderCode:12751292185afadd692f81d7-38459182%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '48eaf081636ff22f0cd876e0328a706843a99660' => 
    array (
      0 => 'D:/Develop/xampp/htdocs/vr720/template\\default\\member\\project.lbi',
      1 => 1495316089,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12751292185afadd692f81d7-38459182',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5afadd6968e22',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5afadd6968e22')) {function content_5afadd6968e22($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (($_smarty_tpl->tpl_vars['_lang']->value['moban'])."/library/member_paths.lbi", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
			...
			$("#pager_wrap").html("");
			  ...
			  '<div class="item">'+
			    '<div class="item-content">'+
			    	...
			    	'</div>'+
			    	'<div class="pull-left works_intro" >'+
			    		'<a href="/video/play.html?vid='+o.id+'" class="works_name" target="_blank">'+o.vname+'</a>&nbsp;&nbsp;&nbsp;&nbsp;'+
			    		...
			    		'<a href="/video/play.html?vid='+o.id+'" class="works_preview" target="_blank">预览</a>'+
			    		'<div class="text-muted">'+
			    			'<span>'+o.create_time+'</span>'+
			    			'&nbsp;&nbsp;'+
			    			'<span><i class="icon icon-thumbs-o-up"></i>&nbsp;'+o.praised_num+'</span>&nbsp;&nbsp;'+
